      ...
      <form onSubmit={handleSubmit} >
        ...
        <Row className="mb-3">
          ...
          <Col xs="12" sm="12" md="12" lg="4" xl="4">
            ...
            {validation_error.length > 0 ? validation_error.map((error, i) => error.param === "password" ? (<><span key={i} style={{ color: "#ff0000", fontSize: "12px"}}>{error.msg}</span> <br /></>) : null): null}
          </Col>
        </Row>
        ...
        <Row className="mb-3">
          ...
          <Col xs="12" sm="12" md="12" lg="4" xl="4">
            ...
            <input id="zone" type="text" name="zone" onChange={(e) => handleChange(e)} value={zone} placeholder="Enter zone" className="form-control" />
            {validation_error.length > 0 ? validation_error.map((error, i) => error.param === "zone" ? (<><span key={i} style={{ color: "#ff0000", fontSize: "12px"}}>{error.msg}</span> <br /></>) : null): null}
          </Col>
        </Row>
