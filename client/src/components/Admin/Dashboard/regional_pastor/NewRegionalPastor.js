      ...
      <form onSubmit={handleSubmit} >
        <Row className="mt-4 mb-4">
          <Col xs="12" xl="4">
            ...
            <div {...getRootProps()} className="text-center r-file-uploader">
              {upload_loading ? <h4 className="text-center">Uploading file. Please wait...</h4> : 
        ...
        <Row className="mb-3">
          ...
          <Col xs="12" sm="12" md="12" lg="4" xl="4">
            ...
            {validation_error.length > 0 ? validation_error.map((error, i) => error.param === "region" ? (<><span key={i} style={{ color: "#ff0000", fontSize: "12px"}}>{error.msg}</span> <br /></>) : null): null}
          </Col>
        </Row>
