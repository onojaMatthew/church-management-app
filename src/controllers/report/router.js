...
router.post("/report/new", verifyToken, grantAccess("createOwn", "branch church"), create_report);
router.get("/report/all", verifyToken, grantAccess("readAny", "super admin"), report_list);
router.get("/report/details", verifyToken, grantAccess("readOwn", "branch church"), report_details);
...
router.get("/report/church_reports", verifyToken, grantAccess("readOwn", "branch church"), report_by_church);
router.get("/report/search", verifyToken, grantAccess("readOwn", "branch church"), searchReport);
router.put("/report/viewed", verifyToken, grantAccess("readOwn", "branch church"), viewed);
router.get("/report/filter", verifyToken, grantAccess("readOwn", "branch church"), report_filter);
