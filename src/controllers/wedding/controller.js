...
export const create = async (req, res) => {
  const { groom_first_name, groom_last_name, groom_phone_number, wedding_picture, bride_first_name, bride_last_name, bride_phone_number, venue,date,lead_pastor, } = req.body;
...
export const updateWedding = async (req, res) => {
  ...
  try {
    ...
    if (req.body.groom_first_name) wedding.groom.first_name = req.body.groom_first_name
    if (req.body.groom_last_name) wedding.groom_last_name = req.body.groom_last_name
    if (req.body.groom_phone_number) wedding.gro.m.phone_number = req.body.groom_phone_number
    if (req.body.bride_first_name) wedding.groom.first_name = req.body.bride_first_name;
    if (req.body.bride_last_name) wedding.bride.last_name = req.body.bride_last_name
    if (req.body.bride_phone_number) wedding.bride.phone_number = req.body.bride_phone_number
    if (req.body.bride_phone_number) wedding.bride.phone_number = req.body.bride_phone_number
    ...
    if (req.body.wedding_picture) wedding.wedding_picture = req.body.wedding_picture;
