...
export const roles = () => {
  ...
  ac.grant("super admin").extend("regional pastor").extend("zonal pastor").extend("resident pastor").extend("user").extend("admin").extend("branch church").readAny("super admin").updateAny("super admin").createAny("super admin").deleteAny("super admin");
